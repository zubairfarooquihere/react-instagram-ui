  ...
  return (
    <div className={classes.reels}>
      <div className={classes.newReelBtn}>
        <div
          className={classes.newReelBtn__top}
          onClick={() => {
            showNewReel(false);
          }}
        />
        <div
          className={classes.newReelBtn__bottom}
          onClick={() => {
            showNewReel(true);
          }}
        />
      ...
      <div
        key={divId[0]}
        id={classes[divId[0]]}
        className={classes.reels__reel}
      >
        <Reel key={reel10 + " reel"} showNewReel={showNewReel} reelId={reel10} />
      </div>
      <div
        key={divId[1]}
        id={classes[divId[1]]}
        className={classes.reels__reel}
      >
        <Reel key={reel1 + " reel"} showNewReel={showNewReel} reelId={reel1} />
      </div>
      <div
        key={divId[2]}
        id={classes[divId[2]]}
        className={classes.reels__reel}
      >
        <Reel key={reel2 + " reel"} showNewReel={showNewReel} reelId={reel2} />
      </div>
      <div
        key={divId[3]}
        id={classes[divId[3]]}
        className={classes.reels__reel}
      >
        <Reel key={reel4 + " reel"} showNewReel={showNewReel} reelId={reel4} />
      </div>
    </div>
  );
}
